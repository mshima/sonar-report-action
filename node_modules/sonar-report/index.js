...
const buildCommand = ({createCommand, createOption} = commander) => createCommand()
  .description('Generate a vulnerability report from a SonarQube instance.')
  .addOption(createOption('--http-proxy', 'the proxy to use to reach the sonarqube instance (http://<host>:<port>)').env('http_proxy'))
